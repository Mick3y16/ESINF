...
// Overriden methods        
    ...
    public boolean equals(Object obj) {
        ...
        DoublyLinkedList otherThis = (DoublyLinkedList) obj;
        
        if (this.size() != otherThis.size()) {
            return false;
        }

        Iterator<E> thisIterator = this.iterator();
        Iterator<E> otherIterator = otherThis.iterator();
...
//---------------- nested DoublyLinkedListIterator class ----------------        
    private class DoublyLinkedListIterator implements ListIterator<E> {
        ...
        public E next() throws NoSuchElementException {
            ...
            lastReturnedNode = prevNode = prevNode.getNext();
        ...
        public E previous() throws NoSuchElementException {
            ...
            lastReturnedNode = nextNode = nextNode.getPrev();

...
public class DoublyLinkedListTest {
    ...
    public void superTest() {
        ...
        DoublyLinkedList<Integer> instance1 = new DoublyLinkedList<Integer>(){};
        DoublyLinkedList<String> instance2 = new DoublyLinkedList<String>(){};
        
        Class instance1Type = (Class) ((ParameterizedType) instance1.getClass().getGenericSuperclass()).getActualTypeArguments()[0];
        Class instance2Type = (Class) ((ParameterizedType) instance2.getClass().getGenericSuperclass()).getActualTypeArguments()[0];
        
        boolean expectedResult = false;
        boolean result = instance1Type.getName().equals(instance2Type.getName());
